#ifndef DIV0_TYPES_STORAGE_SLOT_H
#define DIV0_TYPES_STORAGE_SLOT_H
...
class StorageSlot {
 public:
  ...
  constexpr explicit StorageSlot(const Uint256& value) : value_(value) {}
...
#endif  // DIV0_TYPES_STORAGE_SLOT_H
